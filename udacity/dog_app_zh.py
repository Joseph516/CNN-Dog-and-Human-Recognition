...
# 
# __回答:__    
# 这里采用InceptionV3搭建最终的网络框架。先是通过全局池化层得到经迁移训练后的数据，再通过两次Dropout和全连接层的组合使用，得到输出133节点，激活函数为softmax的全连接层。这样可以增加某些数据的权重，以使数据能最大程度地被利用，避免过拟合。因此获得80%的准确率。    
# 
# 
# 
...
# __以下为测试图片：__  
# 
# American_water_spaniel | Brittany | Curly-coated_retriever | Welsh_springer_spaniel | Chihuahua
# - | -
# <img src="images/American_water_spaniel_00648.jpg" width="200" > | <img src="images/Brittany_02625.jpg" width ="150" > | <img src="images/Curly-coated_retriever_03896.jpg" width="220"> | <img src="images/Welsh_springer_spaniel_08203.jpg" width="220"> | <img src="images/Chihuahua.jpg" width="200">
# 
# German Shepherd | teddy | human_yuanquan | flower-purple | human_slash
# - | -
# <img src="images/German Shepherd.jpg" width="150">| <img src="images/teddy.jpg" width="220"> | <img src="images/human_yuanquan.jpg" width="150"> | <img src="images/flower-purple.jpg" width="220"> | <img src="images/human_slash.jpg" width="220"> 
